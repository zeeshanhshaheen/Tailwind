...
var _gridAutoColumns = _interopRequireDefault(require("./plugins/gridAutoColumns"));
...
var _gridAutoRows = _interopRequireDefault(require("./plugins/gridAutoRows"));
...
function _default({
  ...
  return (0, _configurePlugins.default)(corePluginConfig, Object.keys(corePluginList)).map(pluginName => {
